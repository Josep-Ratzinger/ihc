...
public class ChessBoardState : MonoBehaviour
{
    ...
    [Header("Refs")]
    public BoardBounds board;   // arr�stralo

    // Ocupaci�n por casilla
    ...
    {
        // elimina ubicaci�n anterior de ese gate
    ...
    {
        // v�lido SOLO en el turno inmediatamente siguiente
        if (enPassant.valid &&
